        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
          {testimonials.map((testimonial, index) => (
            <div key={index} className="card" style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <p style={{ color: 'var(--dark-navy)', fontSize: '1rem', fontStyle: 'italic', marginBottom: '2rem', flex: 1 }}>
                "{testimonial.quote}"
              </p>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <div>
                  <h4 style={{ fontWeight: 600, color: 'var(--dark-navy)', fontSize: '1rem' }}>{testimonial.name}</h4>
